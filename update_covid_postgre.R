...
dbWriteTable(pgcon, name = "asean", value = asean, overwrite = TRUE)
...
dbWriteTable(pgcon, name = "dailynasional", value = dailynasional, overwrite = TRUE)
...
# 
# dbWriteTable(pgcon, name = "geom_provinsi", value = geom_provinsi, overwrite = TRUE)
...
dbWriteTable(pgcon, name = "dailyprovinsi", value = dailyprovinsi, overwrite = TRUE)
